        ...
        return this.each(function () {
            ...
            var sortkeys = ["shiftKey", "altKey", "ctrlKey"],
                ...
                addMulti = function (rowid, pos, irow, checked, uiclass) {
                    ...
                    //addNewRow： var v = "<div class=\"ckbox\"><input role=\"checkbox\" type=\"checkbox\"" + " id=\"jqg_" + t.p.id + "_" + rowid + "\"><label for=\"jqg_" + t.p.id + "_" + rowid + "\"></label></div>";
                    var v = "<div class=\"ckbox\"><input role=\"checkbox\" type=\"checkbox\"" + " id=\"jqg_" + ts.p.id + "_" + rowid + "\" " + uiclass + " name=\"jqg_" + ts.p.id + "_" + rowid + "\"" + (checked ? "checked=\"checked\"" : "") + "/><label for=\"jqg_" + ts.p.id + "_" + rowid + "\"></label></div>",
                ...
                endReq = function () {
                    ...
                    if (ts.p.unwritten) {
                        ...
                        if ($("#" + ts.p.id).find('tbody tr').length == 1) {
                            //fxx 原： $("#" + ts.p.id).parents('.ui-jqgrid-bdiv').append('<div class="unwritten" style="color:red;padding:7px;border-bottom:#ddd 1px solid;">没有找到您要的相关数据!</div>')
                            $($("#" + ts.p.id).parents('.ui-jqgrid-bdiv')[0]).append('<div class="unwritten" style="color:red;padding:7px;border-bottom:#ddd 1px solid;">没有找到您要的相关数据!</div>')
                        }
                    }
                },
            ...
            $(ts).before(grid.hDiv).click(function (e) {
                ...
                if (td.tagName === 'A' || ((td.tagName === 'INPUT' || td.tagName === 'TEXTAREA' || td.tagName === 'OPTION' || td.tagName === 'SELECT' || td.tagName === "LABEL") && !scb)) { return; }
                ri = ptr[0].id;
                ...
                this.each(function () {
                    ...
                    while (k < datalen) {
                        ...
                        if (gi) {
                            ...
                            v = "<div class=\"ckbox\"><input role=\"checkbox\" type=\"checkbox\" class=\"cbox checkbox\"" + " id=\"jqg_" + t.p.id + "_" + rowid + "\"><label for=\"jqg_" + t.p.id + "_" + rowid + "\"></label></div>";
                ...
                if (edtrul.custom === true) {
                    if (!(rqfield === false && $.jgrid.isEmpty(val))) {
                        if ($.isFunction(edtrul.custom_func)) {
                            ...
                            //var ret = edtrul.custom_func(g, val, nm, valref);
                ...
                if (editable === "0" && !$(ind).hasClass("not-editable-row")) {
                    ...
                    if (cnt > 0) {
                        ...
                        if (o.focusField) {
                            ...
                            setTimeout(function () {
                                // by fxx
                                var custoumFocus = $("td input:visible[focus=true]", ind).not(":disabled");
                                if (custoumFocus != undefined) {
                                    custoumFocus.removeAttr("focus");
                                    custoumFocus.focus();
                                }
                                else {
            ...
            return this.each(function () {
                ...
                if (!rc[expanded]) {
                    ...
                    if ($(this).jqGrid("isNodeLoaded", this.p.data[position])) {
                        rc[expanded] = true;
                        //this.p.data[position][expanded] = true; // by Fxx
                        $("div.treeclick", rc1).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus");
            ...
            return this.each(function () {
                ...
                if (rc[expanded]) {
                    var id = $.jgrid.getAccessor(rc, this.p.localReader.id),
                        ...
                        rc1 = $("#" + this.p.idPrefix + $.jgrid.jqID(id), this.grid.bDiv)[0];
                    //this.p.data[this.p._index[id]][expanded] = false; // add by fxx
                    rc[expanded] = false;
                    if (ret === false) { return; }
