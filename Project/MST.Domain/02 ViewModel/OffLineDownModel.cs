...
namespace MST.Domain.ViewModel
{
    ...
    public class OffLineDownModel
    {
		...
		/// 货位状态名称(来源于库存)
		/// </summary>
		public string ConDetailLocationStateName { get; set; }
		...
		/// 库存状态名称(来源于库存)
		/// </summary>
		public string ConDetailStateName { get; set; }
		...
		public List<ContainerDetailModel> ContainerDetailModelList { get; set; }
	}
}
