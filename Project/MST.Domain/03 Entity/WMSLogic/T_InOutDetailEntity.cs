...
{
  /// <summary>
  /// 凡是T_ContainerDetail表中的当前数量Qty变动，都要插入该表
  /// </summary>
  public class T_InOutDetailEntity : IEntity<T_InOutDetailEntity>, ICreationAudited, IModificationAudited, IDeleteAudited , IWMSEntity
  {
		/// <summary>
		/// 库存流水ID
		/// </summary>
		...
		/// <summary>
		/// 质检结果。Qua 合格，UnQua 不合格,UnNeed  免检,WaitCheck 待检
		/// </summary>
