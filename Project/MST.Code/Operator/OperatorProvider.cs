...
namespace MST.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "MST_loginuserkey_2021";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("MST_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("MST_licence", Licence.GetLicence());
        }
        ...
        public void RefrshCookieExpTime(OperatorModel operatorModel)
        {
            if (LoginProvider == "Cookie")
            {
                WebHelper.WriteCookie(LoginUserKey, DESEncrypt.Encrypt(operatorModel.ToJson()), 60);
