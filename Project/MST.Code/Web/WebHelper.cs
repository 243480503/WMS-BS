...
namespace MST.Code
{
    public class WebHelper
    {
        ...
        public static string HttpWebRequest(string url,bool isPost)
        {
            return HttpWebRequest(url, string.Empty, Encoding.GetEncoding("utf-8"), isPost);
        }
        ...
        public static string HttpWebRequest(string url, string parameters,bool isPost)
        {
            return HttpWebRequest(url, parameters, Encoding.GetEncoding("utf-8"), isPost);
        }
